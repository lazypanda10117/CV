...
\begin{rSection}{Interests}
	% I am interested in the intersection of mathematics and computer science. 
	I am mainly interested in graph theory and its algorithmic implications in computer science, such as algorithm design, coding theory, and discrete optimization. 
...
\begin{rSubsection}{Relevant Courses}{}{}{}
	...
	\item Undergraduate: algebraic graph theory, network flow theory, coding theory, algebraic number theory, neural networks, statistical foundation for machine learning, algorithms
\end{rSubsection}
\end{rSection}
...
\begin{rSubsection}{University of Waterloo}{May 2021 - present}{Undergraduate Research Fellow \\ Supervised by Shane McIntosh}{Waterloo, Canada}
	\item To develop graph extraction software and analyze such graphs. (Details to be included)
\end{rSubsection}
...
\begin{rSubsection}{University of Waterloo}{Dec 2020}{Frank Lun Scholarship for Excellence}{\$1000}
...
\begin{tabular}{ @{} >{\bfseries}l @{\hspace{6ex}} l }
	...
	Tools & Git, C++ tools (i.e. GCC, GDB), Docker, Linux, PLY, PyTorch, Jupyter
\end{tabular}
\end{rSection}
